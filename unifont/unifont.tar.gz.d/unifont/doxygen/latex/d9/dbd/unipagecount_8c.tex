...
\begin{center}
\leavevmode
\includegraphics[width=202pt]{dc/dc0/unipagecount_8c__incl}
\end{center}
\end{figure}
...
\#define \mbox{\hyperlink{unipagecount_8c_ad7871643c05865c80f5d8050aead2b57}{M\+A\+X\+B\+UF}}~256
...
\begin{DoxyCompactList}\small\item\em Create an H\+T\+ML table linked to P\+NG images. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
Each code point range number can be a hyperlink to a P\+NG file for that 256-\/code point range\textquotesingle{}s corresponding bitmap glyph image.
...
\begin{center}
\leavevmode
\includegraphics[width=217pt]{d9/dbd/unipagecount_8c_a0ddf1224851353fc92bfbff6f499fa97_cgraph}
\end{center}
\end{figure}
...
Create an H\+T\+ML table linked to P\+NG images. 

This function creates an H\+T\+ML table to show P\+NG files in a 16 by 16 grid. The background color of each \char`\"{}page\char`\"{} of 256 code points is shaded from red (for 0\% coverage) to green (for 100\% coverage).
...
\begin{center}
\leavevmode
\includegraphics[width=217pt]{d9/dbd/unipagecount_8c_ab3fa087c3244a7238a3109a42834608c_icgraph}
\end{center}
\end{figure}
