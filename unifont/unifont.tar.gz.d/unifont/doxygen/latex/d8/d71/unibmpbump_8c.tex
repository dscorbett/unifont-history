...
\begin{center}
\leavevmode
\includegraphics[width=273pt]{d7/da2/unibmpbump_8c__incl}
\end{center}
\end{figure}
...
\#define \mbox{\hyperlink{unibmpbump_8c_a1c6d5de492ac61ad29aec7aa9a436bbf}{V\+E\+R\+S\+I\+ON}}~\char`\"{}1.\+0\char`\"{}
...
\#define \mbox{\hyperlink{unibmpbump_8c_aadfd205e5b62832a2ef6266260cb55f1}{M\+A\+X\+\_\+\+C\+O\+M\+P\+R\+E\+S\+S\+I\+O\+N\+\_\+\+M\+E\+T\+H\+OD}}~13
...
unsigned \mbox{\hyperlink{unibmpbump_8c_ace9584f7b69b95621366833332b30465}{get\+\_\+bytes}} (F\+I\+LE $\ast$infp, int nbytes)
...
\end{DoxyCopyright}
This program shifts the glyphs in a bitmap file to adjust an original P\+NG file that was saved in B\+MP format. This is so the result matches the format of a unihex2bmp image. This conversion then lets unibmp2hex decode the result.
...
{\footnotesize\ttfamily unsigned get\+\_\+bytes (\begin{DoxyParamCaption}\item[{F\+I\+LE $\ast$}]{infp,  }\item[{int}]{nbytes }\end{DoxyParamCaption})}
...
This function adjusts the input image from an original P\+NG file to match \mbox{\hyperlink{unihex2bmp_8c}{unihex2bmp.\+c}} format.
